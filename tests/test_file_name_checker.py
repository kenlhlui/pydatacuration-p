...
def test_check_special_chars(input_string, expected_bool):
    ...
    result_file, result_bool = FileNameChecker._check_special_char(input_string)
...
def test_check_file_name_len(input_string, expected_bool):
    ...
    result_file, result_bool = FileNameChecker._check_file_name_len(input_string, FILE_NAME_MAX_LEN)
    assert result_file == input_string
    assert result_bool is expected_bool
...
def test_check_file_ext(input_string, expected_bool):
    ...
    result_file, result_bool = FileNameChecker.check_file_ext(input_string)
    assert result_file == input_string
    assert result_bool is expected_bool
...
def test_check_file_preferred_format(tmp_path):
    ...
    result_file, result_bool = FileNameChecker.check_file_preferred_format(file_valid, config_path)
    assert result_file == file_valid
    assert result_bool is True

    # Test with a non-preferred format
    file_invalid = 'example.jpg'
    result_file, result_bool = FileNameChecker.check_file_preferred_format(file_invalid, config_path)
